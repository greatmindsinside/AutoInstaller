...
GUICtrlSetOnEvent($Button3, "_GUIEvent_Buttons")
...
GUICtrlSetOnEvent($Radio1, "_GUIEvent_Radios")
GUICtrlSetOnEvent($Radio2, "_GUIEvent_Radios")
GUICtrlSetOnEvent($Radio3, "_GUIEvent_Radios")
GUICtrlSetOnEvent($Checkbox1, "_GUIEvent_Checkboxes")
GUICtrlSetOnEvent($Checkbox2, "_GUIEvent_Checkboxes")
GUICtrlSetOnEvent($Checkbox3, "_GUIEvent_Checkboxes")

GUISetOnEvent($GUI_EVENT_SECONDARYDOWN, "_GUIEvent_SecondaryDown") ;Demo for starting rightclick menu
